package com.egrobots.prochat.presentation.screens.home.tabs.groups.groupdetails.editgroup;
...
import com.egrobots.prochat.presentation.screens.home.tabs.groups.creategroup.CreateGroupStepOneFragment;
import com.egrobots.prochat.presentation.screens.home.tabs.groups.creategroup.CreateGroupStepThreeFragment;
import com.egrobots.prochat.presentation.screens.home.tabs.groups.creategroup.CreateGroupStepTwoFragment;
 ...
 * Use the {@link EditGroupMainDialog#newInstance} factory method to
 * create an instance of this fragment.
 */
public class EditGroupMainDialog extends CustomBottomSheetFragment implements AddingGroupListener {

    public static final String TAG = "EditGroupMainDialog";
    ...
    public EditGroupMainDialog() {
        // Required empty public constructor
    }

    public static EditGroupMainDialog newInstance() {
        return new EditGroupMainDialog();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.edit_group_main_layout, container, false);
...
//            currentStep++;
//        } else
        if (isSecondStepCompleted && currentStep == 2) {
            goToStepThree();
            currentStep++;
